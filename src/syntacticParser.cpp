...
bool syntacticParse()
{
    ...
    // cout<<"POSS "<<possibleQueryType<<endl;
    if (possibleQueryType == "CLEAR")
        ...
        return syntacticParseMERGESORT();
    else
    {
...
void ParsedQuery::clear()
{
    ...
    this->orderconditionattribute = "";
    this->ordercondition = "";
    this->orderRelationName = "";

    this->groupResultRelationName = "";
    this->groupInputRelationName = "";
    this->groupSortColumnName = "";
    this->groupFirstAggregateColumnName = "";
    this->groupSecondAggregateColumnName = "";
    this->groupBinaryOperator = "";
    this->groupConditionValue = "";
