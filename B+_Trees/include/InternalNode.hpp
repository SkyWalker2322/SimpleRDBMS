...
public:
    ...
    TreePtr handle_insert_and_split(const TreePtr& child_tree_ptr, TreeNode *child); 
    Key getFirstElement();
    void delete_key(const Key& key, TreePtr left_sibling, TreePtr right_sibling, TreePtr parent, int parent_index) override; 
