...
public:
    ...
    virtual void delete_key(const Key& key, TreePtr left_sibling, TreePtr right_sibling, TreePtr parent, int parent_index) {} 
    ...
    virtual Key getFirstElement(){return DELETE_MARKER;}; 
