...
unordered_map<int, int> bpTreeMap; 
...
void Query::execute_script(string script_name) {
    ...
    /* Wriring block access to file */
    ofstream myfile;                                                                                                                     
    myfile.open (DATA_PATH + "block_access_details_bptree_FANOUT_" + to_string(FANOUT) + ".csv", ios::out | ios::app | ios::binary);     
   
    for(auto it: bpTreeMap) {                                                                                                           
        
        myfile << it.first << "," << it.second << endl;                                                                                  
    }
    myfile.close();                                                                                                                      
    myfile.open (DATA_PATH + "block_access_details_heap_FANOUT_" + to_string(FANOUT) + ".csv", ios::out | ios::app | ios::binary);
